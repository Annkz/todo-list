...
// We will call this function while adding, deleting and checking and unchecking the task

function allTasks(){
    let tasks = document.querySelectorAll(".pending");

    //If tasks length is 0 then pending num text content will be no, if not pending num value will be tasks length
